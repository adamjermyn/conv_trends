...
contains
    ...
    subroutine Lrad_div_Ledd(s,k,val)
        type (star_info), pointer :: s
        integer, intent(in) :: k
        real(dp), intent(out) :: val
    ...
    subroutine stiffness_top(s,k_top,k_bottom,val)
        ...
        call r_average_hp_frac(s,k_top,k_bottom,1.00d0,.true.,.true.,.false.,fc2,brunt2_CZ)
        call r_average_hp_frac(s,k_top,k_bottom,1.00d0,.false.,.true.,.false.,N2_RZ,brunt2_RZ)
    ...
    subroutine stiffness_bottom(s,k_top,k_bottom,val)
        ...
        call r_average_hp_frac(s,k_top,k_bottom,1.00d0,.true.,.false.,.false.,fc2,brunt2_CZ)
        call r_average_hp_frac(s,k_top,k_bottom,1.00d0,.false.,.false.,.false.,N2_RZ,brunt2_RZ)
